...
class TestPowerUps(unittest.TestCase):
    ...
    def test_slow_powerup(self):
        ...
        self.assertTrue(any(p["type"] == PowerUp.TYPE_SLOW for p in self.level.active_powerups))
    ...
    def test_reverse_powerup(self):
        ...
        self.assertTrue(any(p["type"] == PowerUp.TYPE_REVERSE for p in self.level.active_powerups))
